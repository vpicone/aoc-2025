// Day 2: Find "invalid" IDs where the number can be split into identical repeating clusters.
// Strategy: For each number in ranges, check all possible cluster sizes (1 to half-length).
// If all clusters are identical (e.g., "234234" → "234","234"), the ID is invalid.
const input =
